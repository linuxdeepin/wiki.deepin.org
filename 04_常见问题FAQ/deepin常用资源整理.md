...
### 2.4 系统使用及问题解决
> 第三方应用相关问题见“[4.1 软件分享和使用技巧](#h-41-软件分享和使用技巧)”。
...
#### 2.4.3 应用及包管理
> 另见 “[4.1.1.3 软件包管理及应用商店](#h-4113-软件包管理及应用商店)”。
...
#### 2.4.10 命令与终端
> 有些命令行应用在“[4.1 应用分享和使用技巧](#h-41-应用分享和使用技巧)”。
...
## 三、硬件和设备
> 部分硬件相关的资源在“[2.4.4 性能和电源管理](#h-244-性能和电源管理)”。
