...
- 优化字体的显示
> 出处
见 [https://bbs.deepin.org/post/259333](https://bbs.deepin.org/post/259333) 14楼。 {.is-info}
...
> 出处
见 [https://bbs.deepin.org/post/253670](https://bbs.deepin.org/post/253670) 3楼。 {.is-info}
...
## 清理不需要的系统内核（待斟酌）
> 出处
见 [https://bbs.deepin.org/post/253636](https://bbs.deepin.org/post/253636) 2楼。 {.is-info}
...
## 放大镜
> 出处
见 [https://bbs.deepin.org/post/253561](https://bbs.deepin.org/post/253561) 回复。 {.is-info}
...
## 加入内测后部分软件安装出现问题
> 出处
见 [https://bbs.deepin.org/zh/post/254022](https://bbs.deepin.org/zh/post/254022) 7楼。 {.is-info}
...
## 调整安卓应用的宽高、默认横屏等显示参数
> 出处
见 [https://bbs.deepin.org/post/255732](https://bbs.deepin.org/post/255732) 2楼。 {.is-info}
...
## 清除文件管理器的地址栏历史
> 出处
见 [https://bbs.deepin.org/post/254424](https://bbs.deepin.org/post/254424) 3楼。 {.is-info}
...
> 出处
见 [https://bbs.deepin.org/post/254090](https://bbs.deepin.org/post/254090) 6楼。 {.is-info}
