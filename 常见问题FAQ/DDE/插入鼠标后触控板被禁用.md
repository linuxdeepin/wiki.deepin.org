...
(2)查看gsetting值：gsettings get com.deepin.dde.touchpad touchpad-enabled
发现返回值是false

通过修改 gsettings set com.deepin.dde.touchpad touchpad-enabled true
就不存在这个问题了
