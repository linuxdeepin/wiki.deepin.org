...
总而言之：Arch Linux 是一个多功能且简单的发行版，旨在满足有能力的 Linux® 用户的需求。它功能强大且易于管理，使其成为服务器和工作站的理想发行版。把它带到你喜欢的任何方向。如果您对 GNU/Linux 发行版应该是什么样子有同样的看法，那么我们欢迎并鼓励您自由使用它、参与其中并为社区做出贡献。